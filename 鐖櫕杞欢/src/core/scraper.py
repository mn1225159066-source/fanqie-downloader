...
from .path_utils import get_desktop_path
...
class FanqieScraper:
    ...
    def get_novel_metadata(self, url):
        try:
            ...
            return {"title": title, "author": author, "cover_url": cover_url, "url": url}
    ...
    def get_chapter_content(self, chapter_url):
        ...
        try:
            ...
            return {"content_html": str(content_div), "font_url": font_url}
        except Exception as e:
            ...
            if font_url:
                try:
                    ...
                    if mapping:
                        ...
                        for char in text:
                            code = ord(char)
                            new_text += mapping.get(code, char)
                        text = new_text
                    else:
